...
import ModalBulletinBoard from "./ModalBulletinBoard";
import AnimBox2 from "@animation/AnimBox2";

export default function ModalContainer({ handlerActiveModal, activeModal ,bulletinListData}) {
  return (
    <>
      <AnimBox
        y={200}
      ...
      >
        <div className="flex flex-col font-semibold bg-white rounded-3xl">
          ...
          <ModalBulletinBoard bulletinId={activeModal} bulletinListData={bulletinListData} />
        </div>
      </AnimBox>
